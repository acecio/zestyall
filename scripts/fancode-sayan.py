...
def main():
    ...
    try:
        ...
        with open('api/fancode.json', 'w', encoding='utf-8') as f:
            json.dump(data, f, indent=4, ensure_ascii=False)
        print("Saved full JSON to api/fancode.json")

        m3u_content = generate_m3u(data)
        with open('playlists/fancode-sayan.m3u', 'w', encoding='utf-8') as f:
            f.write(m3u_content)
        print("Saved M3U playlist to playlists/fancode-sayan.m3u")
